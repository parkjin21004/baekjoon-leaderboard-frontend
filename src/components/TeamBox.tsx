...
function TeamBox({ team }: { team: Team }) {
    return (
        <div className="bg-lightgrey border-subblue-300 flex w-fit flex-col items-center justify-between gap-4 rounded-xl border-4 px-2 py-2 xl:w-full xl:flex-row xl:pr-2 xl:pl-10">
